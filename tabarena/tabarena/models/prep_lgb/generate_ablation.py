...
gen_lightgbm = CustomAGConfigGenerator(
    ...
    manual_configs=[
        { #1 Only arithmetic: Keep all original + arithmetic
        'ag.prep_params': [
            [
        ...
        'ag.prep_params.passthrough_types': {}, # We never keep categorical features
        'ag.use_residuals': False,
        'ag.residual_type': 'oof',
        'ag.max_dataset_size_for_residuals': 1000,
        'ag.residual_init_kwargs': {},
        },
        { #3 Only CatFE (without converting base to OOF): : Keep all original + CatOOFTE
        'ag.prep_params': [
            [
                [
        ...
        { #4 Only OOF-TE without Cat Interactions: Replace original cat featrues with OOF-TE
        'ag.prep_params': [
            [
                ['OOFTargetEncodingFeatureGenerator', {}],
            ],            
        ...
        { #5 Only groupby: : Keep all original + relative groupby
        'ag.prep_params': [
            [
        ...
        { #6 Only absolute groupby, but all kinds of groupby features: Keep all original + groupby
        'ag.prep_params': [
            [
                ['GroupByFeatureGenerator', {
                    "aggregations": ("mean","median", "std", "min", "max", "nunique"), # 
                    "relative_to_aggs": (),
                    "relative_ops": (),}
                    ],
            ],            
        ...
        { #7 OOF-TE with keeping categorical features: Keep all original + OOF-TE
        'ag.prep_params': [
            [
                ['OOFTargetEncodingFeatureGenerator', {}],
            ],            
        ...
        { #8 OOF-TE with GroupBy: Original numeric + OOF-TE + RelGroupBy
        'ag.prep_params': [
            [
                ['GroupByFeatureGenerator', {}],
                ['OOFTargetEncodingFeatureGenerator', {}],
        ...
        { #9 Order-2 arithmetic: all original + 2-arithmetic
        'ag.prep_params': [
            [
                ['ArithmeticFeatureGenerator', {"max_order": 2}],
            ],            
        ['SpearmanFeatureSelector', {'max_features': 2000}]            
        ],
        'ag.prep_params.passthrough_types': {}, # We never keep categorical features
        ...
        { #10 Arithmetic - Only ratios and products: all original + ratios & products
        'ag.prep_params': [
            [
                ['ArithmeticFeatureGenerator', {"interaction_types": ["/", "*"]}],
            ],            
        ['SpearmanFeatureSelector', {'max_features': 2000}]            
        ],
        'ag.prep_params.passthrough_types': {}, # We never keep categorical features
        ...
        { #11 Arithmetic - Only sums and differences: All original + sums & diffs
        'ag.prep_params': [
            [
                ['ArithmeticFeatureGenerator', {"interaction_types": ["-", "+"]}],
            ],            
        ...
        { #12 Full categorical pipeline with dropping original
        'ag.prep_params': [
            [
                ['GroupByFeatureGenerator', {}],
        ...
        { #13 Full categorical pipeline with keeping original
        'ag.prep_params': [
            [
                ['GroupByFeatureGenerator', {}],
                ['RandomSubsetTAFC', {"only_cat": True}],
