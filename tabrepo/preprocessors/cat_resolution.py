...
from tabprep.cat_resolution_detection import CatResolutionDetector
...
class CatResAutoMLPipelineFeatureGenerator(AutoMLPipelineFeatureGenerator):
    def __init__(self,
        target_type: str,
        **kwargs,
    ):
        ...
        self.detector = CatResolutionDetector(
            ...
            operation_mode='full',  # 'sequential' or 'full'
            max_to_test=100,  # maximum number of unique values to test
            drop_unique=False, cv_method='regular'
            )
...
class FromCSVCatResAutoMLPipelineFeatureGenerator(AutoMLPipelineFeatureGenerator):
    def __init__(self,
        target_type: str,
        **kwargs,
    ):
