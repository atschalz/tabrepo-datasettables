...
from tabprep.cat_interaction import CategoricalInteractionDetector
from autogluon.features.generators import CategoryFeatureGenerator

class CatIntAutoMLPipelineFeatureGenerator(AutoMLPipelineFeatureGenerator):
    def __init__(self,
        target_type: str,
        **kwargs,
    ):
        ...
        self.detector = CategoricalInteractionDetector(
