...
from tabprep.cat_treatment import CatTreatmentDetector
from autogluon.features.generators import CategoryFeatureGenerator

class CatTreatAutoMLPipelineFeatureGenerator(AutoMLPipelineFeatureGenerator):
    def __init__(self,
        target_type: str,
        **kwargs,
    ):
        ...
        self.detector = CatTreatmentDetector(
